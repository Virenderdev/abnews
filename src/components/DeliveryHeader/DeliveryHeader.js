  ...
  const menu = [
    {
      ...
      items: [
        {
          name: 'Prawn Crackers',
          description: 'A basket of crunchy thai style prawn crackers served with sweet chilli droppong souce',
          image: image1,
        },
      ],
    },
            ...
            <div className="d-flex flex-row justify-content-center menu-container sticky">
              {menu.map((button, index) => (
                <Button
                  ...
                  style={{ width: 'auto', height: '30px', margin: '0 5px', color: '#00CCBC' }}
                  className="bg-transparent border-0 border-rounded"
          ...
          <Row>
            ...
            <Col md={8}>
              <div className="filtered-items-container">
                ...
                {showPopover && selectedMenuItem && (
                  <MapContainer address={selectedMenuItem.address} />
                )}
              </div>
            </Col>
            {/* Sticky second card */}
              ...
              <Card>
                <div className="card-body checkout">
                  <div className="text-center">
                    ...
                    <p className="fs-4" style={{ color: '#abadad' }}>
